...
figlet "MrD0nx Allto"
echo $w"///////////////////////////////////////////"
echo $cy" Author"$r"  : "$cy"MrD0nx"
echo $cy" pembuat"$r" : "$cy"MrD0nx"
echo $cy" Team"$r"    : "$cy"IndoDarknet"
echo $cy" Instagram"  : $cy"moh.dito_"
echo $w"///////////////////////////////////////////"
	sleep 4
echo
echo
